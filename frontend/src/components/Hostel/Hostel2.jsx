...
function Description() {
  return (
    <p className="hostel-description">
     Our cabin hostel offers shared outdoor kitchen, cozy communal spaces, and scenic nature views, perfect for budget travelers seeking authentic, peaceful stays with modern amenities and social atmosphere.
    </p>
  );
}
