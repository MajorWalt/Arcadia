...
function Description() {
  return (
    <p className="villa-suite-description">
      Discover the perfect getaway in our 3-suite villa, thoughtfully designed with entertainment areas and private spaces for singles, couples, and groups. Experience ultimate relaxation with a private outdoor baths and a spacious balcony overlooking breathtaking mountain and forest views. 
    </p>
  );
}
